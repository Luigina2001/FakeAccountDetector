...
statistiche = real_users.describe(include='all')
print(f"STATISTICHE:\n{statistiche}")

print("---------------------------------------------------------------------------------------------------------")

colonna = "url"
valori_unici = real_users[colonna].unique()  # calcolo i valori unici dalla colonna
